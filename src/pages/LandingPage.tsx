...
export function LandingPage({ sports }: { sports: Sport[] }) {
  return <main className="landing-page">
    <section className="landing-hero"><p className="eyebrow">SPORTIFY</p><h1>Choose your <em>sport.</em></h1><p>Open a dedicated world of all-time rankings, quizzes, Dream Team drafts and leaderboards.</p></section>
